...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::recording::get_microphone_mute_status,
            commands::recording::set_microphone_muted,
            commands::recording::get_system_output_status,
            commands::recording::set_system_output_volume,
            commands::recording::set_system_output_muted,
            commands::recording::get_application_output_status,
            commands::recording::get_application_output_icon,
            commands::recording::set_application_output_volume,
            commands::recording::set_application_output_muted,
